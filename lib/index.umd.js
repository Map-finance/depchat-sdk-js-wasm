(function (global, factory) {
  ...
  class SDK extends Emitter {
      constructor(url = '/openIM.wasm', debug = true) {
          ...
          this.batchInsertMessageToLocalStorage = (data, operationID = v4()) => {
              return this._invoker('batchInsertMessageToLocalStorage ', window.batchInsertMessageToLocalStorage, [operationID, JSON.stringify(data.message), data.recvID, data.sendID]);
          };
          this.batchInsertMessagesToLocalStorage = (data, operationID = v4()) => {
            return this._invoker('batchInsertMessagesToLocalStorage ', window.batchInsertMessagesToLocalStorage, [operationID, JSON.stringify(data.message)]);
          };
          this.encodeFile = (data, operationID = v4()) => {
            return this._invoker('encodeFile ', window.encodeFile, [operationID, JSON.stringify({
              ...data,
              filepath: '',
              cause: '',
            }),]);
          ...
          this.encodeFile = (data, operationID = v4()) => {
              ...
              data.uuid = `${data.uuid}/${(_a = data.file) === null || _a === void 0 ? void 0 : _a.name}`;
              window.fileMapSet(data.uuid, data.file);
              return this._invoker('encodeFile ', window.encodeFile, [
                  operationID,
                  JSON.stringify({
                      ...data,
                      filepath: '',
