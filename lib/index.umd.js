  ...
  class SDK extends Emitter {
      constructor(url = '/openIM.wasm', debug = true) {
          ...
          this.batchInsertMessagesToLocalStorage = (data, operationID = v4()) => {
            return this._invoker('batchInsertMessagesToLocalStorage ', window.batchInsertMessagesToLocalStorage, [operationID, JSON.stringify(data.message), data.recvID, data.sendID]);
          };
